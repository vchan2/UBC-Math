...
function randomize(){
    ...
    console.log("No restrictions done!");
    ...
    console.log("!v/w done!");
    
    // !aa/z
    if ( aa%z == 0){
        random = 0;
        while(random == 0 || random == 1 || aa%random == 0){
            random = Math.floor(Math.random()*(6+6))-6; 
        }
        z= random;
    }
    console.log("!aa/z done!");
    
    // !cc/bb
    if ( cc%bb == 0){
         random = 0;
        while(random == 0 || random == 1 || cc%random == 0){
            random = Math.floor(Math.random()*(6+6))-6; 
        }
        bb= random;
    }
    console.log("!cc/bb done!");
}
